<div class="p-8 overflow-auto">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-4">
        <a href="<?= htmlspecialchars(base_url('/friends?tab=favorites'), ENT_QUOTES, 'UTF-8') ?>" class="px-5 py-2.5 rounded-xl border transition <?= htmlspecialchars($tabClass($tab === 'favorites'), ENT_QUOTES, 'UTF-8') ?>">Favorites</a>
        <a href="<?= htmlspecialchars(base_url('/friends?tab=online'), ENT_QUOTES, 'UTF-8') ?>" class="px-5 py-2.5 rounded-xl border transition <?= htmlspecialchars($tabClass($tab === 'online'), ENT_QUOTES, 'UTF-8') ?>">Online</a>
        <a href="<?= htmlspecialchars(base_url('/friends?tab=all'), ENT_QUOTES, 'UTF-8') ?>" class="px-5 py-2.5 rounded-xl border transition <?= htmlspecialchars($tabClass($tab === 'all'), ENT_QUOTES, 'UTF-8') ?>">All</a>
        <a href="<?= htmlspecialchars(base_url('/friends?tab=requests&requests=incoming'), ENT_QUOTES, 'UTF-8') ?>" class="px-5 py-2.5 rounded-xl border transition <?= htmlspecialchars($tabClass($tab === 'requests'), ENT_QUOTES, 'UTF-8') ?>">
        ...
        <form id="user-search-form" class="flex items-center gap-3 w-full lg:w-auto">
            <input type="text" id="user-search-input" placeholder="Search users" class="bg-zinc-900 border border-zinc-700 rounded-xl px-5 py-2.5 w-full lg:w-80" required>
            <button type="submit" class="bg-zinc-700 hover:bg-zinc-600 border border-zinc-700 px-5 py-2.5 rounded-xl">Search</button>
        </form>
    </div>

    <div id="user-search-results" class="mb-8 max-w-3xl space-y-2"></div>
