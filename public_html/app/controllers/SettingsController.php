    ...
    public function index() {
        ...
        if ($isAdmin) {
            ...
            $viewData = array_merge($viewData, [
                ...
                'ai_base_url' => AiModerationService::getConfiguredBaseUrl(),
                'ai_model' => AiModerationService::getConfiguredModel(),
                'ai_api_key_configured' => AiModerationService::hasConfiguredApiKey(),
                'ai_api_key_masked' => AiModerationService::getMaskedApiKey(),
                'ai_scan_enabled' => AiModerationService::isScanEnabled(),
                'ai_verified_current' => AiModerationService::isVerifiedForCurrentConfig(),
                'ai_last_test_status' => (string)(Setting::get(AiModerationService::SETTING_LAST_TEST_STATUS) ?? 'pending'),
                'ai_last_tested_at' => trim((string)(Setting::get(AiModerationService::SETTING_LAST_TESTED_AT) ?? '')),
                'ai_last_test_error' => trim((string)(Setting::get(AiModerationService::SETTING_LAST_TEST_ERROR) ?? '')),
