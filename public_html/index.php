...
$router->post('/api/chats/group/promote-moderator', 'ChatController@promoteGroupModerator');
...
$router->post('/api/chats/group/deny-request', 'ChatController@denyGroupJoinRequest');
